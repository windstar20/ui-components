...
const routesPaths = ['/', '/test1', '/test2', '/test2/vanilla', '/test2/react'] as const;

export type ROUTE_PATH = typeof routesPaths[number];
...
console.log('%c[routes.ts : 56 james ]  =', 'color:yellow;' ,routes['/']);
